...
{
    /// <summary>
    /// State in VPS where the user is shown a Tourist badge unlocked message.
    /// Its next state (values assigned via inspector) is either:
    /// - StateVpsBespokePlantFlag if the user accepts the unlock message.
    ...
    /// </summary>
    public class StateVpsBespokeBadgeUnlocked : StateBase
    {
