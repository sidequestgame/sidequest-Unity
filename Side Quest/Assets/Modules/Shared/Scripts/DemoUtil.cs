...
{
    /// <summary>
    /// Utility methods for scenes, including:
    ...
    public static class DemoUtil
    {
        ...
        public static IEnumerator FadeInGUI(GameObject gui,
                                            ...
                                            BubbleScaleAnimationType bubbleScaleAnimationType = BubbleScaleAnimationType.Quick,
                                            Action onComplete = null)
        {
            if (DemoUtil.bubbleScaleGUIs)
            {
                ...
                yield return DemoUtil.DisplayWithBubbleScaleRoutine(gui, targetScale: 1f, show: true,
                    animationType: bubbleScaleAnimationType, initialDelay: initialDelay, onComplete: onComplete);
            }
            else
            {
#pragma warning disable 0162
                ...
                fader.Fade(guiCanvasGroup, alpha: 1f, duration: fadeDuration, onComplete: onComplete, initialDelay: initialDelay);
                                                ...
                                                BubbleScaleAnimationType bubbleScaleAnimationType = BubbleScaleAnimationType.Quick)
        {
            if (DemoUtil.bubbleScaleGUIs)
            {
                yield return DemoUtil.DisplayWithBubbleScaleRoutine(gui, targetScale: 0f, show: false,
                    animationType: bubbleScaleAnimationType, postDelay: 0.383f);
            }
            else
            {
#pragma warning disable 0162
